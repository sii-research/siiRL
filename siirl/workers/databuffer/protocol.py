...
class DataProto:
        ...
        for key, tensor in tensors.items():
            if batch_size is None:
                ...
                assert batch_size == current_batch, (
                    ...
                    f" {pivot_key} has {batch_size}, {key} has {current_batch}"
                )
    ...
    def pop(self, batch_keys=None, non_tensor_batch_keys=None, meta_info_keys=None) -> "DataProto":
        ...
        Returns:
            DataProto: the DataProto with the pop batch_keys and meta_info_keys
        """
    ...
    def make_iterator(self, mini_batch_size, epochs, seed=None, dataloader_kwargs=None):
        ...
        Args:
            ...
            dataloader_kwargs (Any): internally, it returns a DataLoader over the batch. The dataloader_kwargs is
            the kwargs passed to the DataLoader.
    ...
    def padding(self, padding_size, padding_candidate=""):
        """Pad the DataProto by concate with padding_candidate.repeat(padding_size)
...
class DataProtoFuture:
    ...
    - DataProtoFuture only supports directly passing from the output of a method to another input.
    You can't perform any
